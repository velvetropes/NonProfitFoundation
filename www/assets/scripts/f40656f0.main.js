(function() {
    ...
    sfDirectives = angular.module("sfDirectives", [ "ngSanitize", "sfFilters" ]), sfDirectives.directive("href", [ "$location", function($location) {
        return {
        ...
        return _composeFilterObject = function(filters) {
            ...
            scope.paginationLowerWindowLimit = 3, scope.parseDate = function(date) {
                return Date.parse(date);
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                scope.hideModal = function() {
                    ...
                    return newVal && !oldVal ? (scope.iframeContent = newVal.replace(/(?:http(?:s?):\/\/)?(?:www\.)?(?:youtube\.com|youtu\.be)\/(?:watch\?v=)?(.+)/g, '<iframe width="100%" height="100%" src="https://www.youtube.com/embed/$1?autoplay=1" frameborder="0" allowfullscreen></iframe>'), 
    ...
    TabBehavior = function() {
        ...
        if (new HeaderTabNav(), $(".programs-page").length && new ProgramsPageView(), runOnLoad = new Array(), 
