...
if (isset($config))
{
	...
	$env_config['tmpl_file_basepath']        = SHARED_PATH.'/templates';
	 ...
	 * @see config/config.prod.php
	 */
	require SHARED_PATH.'/config/config.' . ENV . '.php';
